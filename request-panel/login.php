...
if (!empty($_POST) && $_POST['submit'] == 'submit') {
  ...
  $user_select = $obj->Query("SELECT * FROM tbl_requester_login WHERE username='$username' and password='$password' AND status = 1");
  ...
  if ($user_select) {
    ...
    $_SESSION['user_id'] = $user_select->rid;
    $_SESSION['request_status'] = "requester-status";
      ...
      <div class="card text-dark border-danger mt-5" >
        ...
        <div class="card-body">
          <form action="" method="post" class="form-group">
            ...
            Don't have an account?<a href="<?=base_url('register_requester.php');?>">Register Now</a>
          </form>
        </div>
      </div>
